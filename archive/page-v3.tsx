...
const Dashboard = () => {
  return (
    <Box p="24px 10px" ml="240px">
      ...
      <Box p="0 0 32px 0" mt="28px" bg="white" border="1px" borderColor="#e7e7e8" borderRadius="md">
        {/* KPI Metrics Row */}
        <Flex width="100%">
          {/* Revenue Metric */}
      ...
      <Flex gap="28px" mt="28px">
        ...
        <Box flex={1} bg="white" border="1px" borderColor="#e7e7e8" borderRadius="md">
        ...
        {/* Activity Feed Card */}
        <Box flex={1} bg="white" border="1px" borderColor="#e7e7e8" borderRadius="md" p="14px 20px">
